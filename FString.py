...
#-----------------OLD Approach----------------
letter = "Hello my namee is {} and i am from {}"
country = "India"
name = "Nirdesh"
print(letter.format(name, country))
letter = "Hello my namee is {1} and i am from {0}"
print(letter.format(country, name ))

# -------------------MODERN APPROACH----------------
print(f"Hello my namee is {name} and i am from {country}")  # This is called fstrings
